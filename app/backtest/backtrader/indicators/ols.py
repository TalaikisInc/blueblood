...
from app.backtest.backtrader import indicators as ind
from . import PeriodN
...
class OLS_TransformationN(PeriodN):
    ...
    def __init__(self):
        ...
        self.l.spread_mean = ind.SMA(spread, period=self.p.period)
        self.l.spread_std = ind.StdDev(spread, period=self.p.period)
