...
from app.backtest.backtrader.strategy import Strategy
from app.backtest.backtrader import TimeFrame, MetaParams, metabase
from app.backtest.backtrader.observer import Observer
from app.backtest.backtrader.utils.py3 import MAXINT, with_metaclass
...
class MetaAnalyzer(MetaParams):
    def donew(cls, *args, **kwargs):
        ...
        masterobs = metabase.findowner(_obj, Observer)
