...
from app.backtest.backtrader.cerebro import Cerebro
from app.backtest.backtrader import Order, sizers
...
class Strategy(with_metaclass(MetaStrategy, StrategyBase)):
    ...
    def _addsizer(self, sizer, *args, **kwargs):
        if sizer is None:
            self.setsizer(sizers.FixedSize())
        else:
