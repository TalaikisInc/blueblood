...
# from app.backtest.backtrader.strategy import Strategy, SignalStrategy
...
class Cerebro(with_metaclass(MetaParams, object)):
    ...
    def add_timer(self, when,
        ...
        Arguments:
          ...
          - ``when``: can be
            ...
            - ``timer.SESSION_START`` to reference a session start
            - ``timer.SESSION_END`` to reference a session end
    ...
    def _runnext(self, runstrats):
        ...
        lastqcheck = False
        dt0 = date2num(datetime.max) - 2  # default at max
        while d0ret or d0ret is None:
