...
from app.backtest.backtrader import TimeFrame, date2num, num2date
from app.backtest.backtrader.feed import DataBase
from app.backtest.backtrader.metabase import MetaParams
from app.backtest.backtrader.utils.py3 import (integer_types, queue, string_types,
                                  with_metaclass)

from app.backtest.backtrader.stores import vcstore
...
class VCData(with_metaclass(MetaVCData, DataBase)):
    ...
    def _gettz(self, tzin=False):
        ...
        if ptz is not None and not tzstr:
            return utils.date.Localizer(ptz)
        ...
        if tzstr:
            ...
            if isinstance(tzs, tzinfo):
                return utils.date.Localizer(tzs)
